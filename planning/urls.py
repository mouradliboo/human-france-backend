...
urlpatterns = [
  path('planning/', PlanningList.as_view(), name='planning-list'),
   ...
   path('lignes/', LigneList.as_view(), name='ligne-list'),
    ...
    path('planning/<int:id>/agents/',PositionnementList.as_view(),name='planning-list-agent'),
    path('planning/<int:id>/agents/<int:pk>/',PositionnementDetail.as_view(),name='planning-list-agent'),
