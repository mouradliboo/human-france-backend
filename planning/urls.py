...
from .views import PlanningList, PlanningDetail, PlanningListAgent,PositionnementList,PositionnementDetail,LigneList, conditionsOfPlanning,LigneDetail, ConditionsList, ConditionsDetail
urlpatterns = [
  path('planning/', PlanningList.as_view(), name='planning-list'),
   ...
   path('lignes/', LigneList.as_view(), name='ligne-list'),
    ...
    path('planning/<int:id>/position/',PositionnementList.as_view(),name='planning-list-agent'),
    path('planning/<int:id>/position/<int:pk>/',PositionnementDetail.as_view(),name='planning-list-agent'),
